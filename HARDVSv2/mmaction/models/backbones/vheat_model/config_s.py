...
_C.MODEL.TYPE = 'vHeat'
# Model name
_C.MODEL.NAME = 'vHeat_small'
# Pretrained weight from checkpoint, could be imagenet22k pretrained weight
# could be overwritten by command line argument
_C.MODEL.PRETRAINED = '../pretrained_model/vHeat_small.pth'
...
_C.MODEL.VHEAT.DEPTHS = [2, 2, 18, 2]   # [2, 2, 18, 2]
_C.MODEL.VHEAT.MLP_RATIO = 4.
_C.MODEL.VHEAT.PATCH_NORM = True
_C.MODEL.VHEAT.POST_NORM = True #True
_C.MODEL.VHEAT.LAYER_SCALE = 1.e-5
