...
from ..backbones.vheat_model import build_model
from ..backbones.vheat_model.config_s import get_config
...
class BaseRecognizer(BaseModel, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        self.backbone = self.built_veat_backbone()
